...
@Component({
  ...
  templateUrl: './espectaculos.page.html',
  styleUrls: ['./espectaculos.page.scss'],
})
export class EspectaculosPage implements OnInit {
