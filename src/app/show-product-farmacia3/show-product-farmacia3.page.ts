...
@Component({
  selector: 'app-show-product-farmacia3',
  templateUrl: './show-product-farmacia3.page.html',
  styleUrls: ['./show-product-farmacia3.page.scss'],
})
export class ShowProductFarmacia3Page implements OnInit {
