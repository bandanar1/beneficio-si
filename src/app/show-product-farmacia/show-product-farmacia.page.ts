...
@Component({
  selector: 'app-show-product-farmacia',
  templateUrl: './show-product-farmacia.page.html',
  styleUrls: ['./show-product-farmacia.page.scss'],
})
export class ShowProductFarmaciaPage implements OnInit {
