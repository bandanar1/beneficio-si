...
@Component({
  selector: 'app-show-supermarket',
  templateUrl: './show-supermarket.page.html',
  styleUrls: ['./show-supermarket.page.scss'],
})
export class ShowSupermarketPage implements OnInit {
