...
@Component({
  selector: 'app-show-product-farmacia2',
  templateUrl: './show-product-farmacia2.page.html',
  styleUrls: ['./show-product-farmacia2.page.scss'],
})
export class ShowProductFarmacia2Page implements OnInit {
