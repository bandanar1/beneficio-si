...
@Component({
  selector: 'app-show-product-farmacia1',
  templateUrl: './show-product-farmacia1.page.html',
  styleUrls: ['./show-product-farmacia1.page.scss'],
})
export class ShowProductFarmacia1Page implements OnInit {
