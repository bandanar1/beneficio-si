...
@Component({
  selector: 'app-data-boliche',
  templateUrl: './data-boliche.page.html',
  styleUrls: ['./data-boliche.page.scss'],
})
export class DataBolichePage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lista = [
      ...
      { selected: false, titulo: 'Tipo de entrada', titulo2: 'Entrada', listado: this.tipoDeEntrada, icon: 'pricetag', show: false }];
  ...
  reservaCancelada(){
    this.loadingCtrl.create({
      ...
      l.present();
      l.onDidDismiss().then(()=>{
        this.navCtrl.navigateRoot('show-boliche').then(()=>{
